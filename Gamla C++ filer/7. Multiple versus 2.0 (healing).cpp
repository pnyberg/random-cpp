...
int main()
{
	int hp1, hp2, hpstart1, hpstart2, lvl1, lvl2, lvltest1=1, lvltest2=1, strength1, strength2, type1, type2, typetest1=1, typetest2=1, att1, att2, atthelp1, atthelp2, atttest1=1, atttest2=1, grassplus1, grassplus2, fireplus1, fireplus2, waterplus1, waterplus2, igen=1, ask=1, turn=0, first=1, goheal, healtest=1;
	char ene='y';
	srand(time(NULL));
	while (lvltest1==1)
	{
	...
	while (hp1>0&&igen==1)
	{
		...
		while (healtest==1)
		{
		cout << "Do you want to go to the Pokémoncenter? " << endl << "1.Yes" << endl << "2.No" << endl << "Type here: ";
		cin >> goheal;
		if (goheal==1||goheal==2)
			healtest--;
		else
		...
		else if (ene=='n')
		{
			...
			cout << "The letter you typed isn't valid, try again!" << endl << endl;
		}
	}
	cout << "The end! ";
	if (hp1==0)
