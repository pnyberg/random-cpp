// beräkningsvoid (om det finns); möta tränare (L1); W6; Kolla så allt funkar! (spec W4)
...
void whattodo (int world, int y, int x, int t1x, int t2x)
{
	cout << "Choose options:" << endl << "1.Move" << endl;
		cout << "2.";
		if (world==1||world==2||world==3||(world==4&&((y==2&&t1x!=x)||(y==3&&t1x!=(x-1)&&t1x!=(x+1)&&t2x!=x)||(y==4&&t1x!=x&&t2x!=(x-1)&&t2x!=(x+1))||(y==5&&t2x!=x)))||(world==5&&((y>3)||(y==3&&x!=4)||(y==2&&x!=3&&x!=5))))
			cout << "Pokémon";
		else 
		{
			cout << "Talk to ";
		...
		if (world==1||world==2||world==3||world==4&&((y==2&&t1x!=x)||(y==3&&t1x!=(x-1)&&t1x!=(x+1)&&t2x!=x)||(y==4&&t1x!=x&&t2x!=(x-1)&&t2x!=(x+1))||(y==5&&t2x!=x))||(world==5&&((y>3)||(y==3&&x!=4)||(y==2&&x!=3&&x!=5))))
			...
			cout << "Shortcuts";
		if ((world==4&&((y==2&&t1x==x)||(y==3&&(t1x==(x-1)||t1x==(x+1)||t2x==x))||(y==4&&(t1x==x||t2x==(x-1)||t2x==(x+1)))||(y==5&&t2x==x)))||(world==5&&((y==2&&(x==3||x==5))||(y==3&&x==4))))
		{
				cout << endl << "5.";
			if (world==4&&((y==3&&(t1x==(x-1)||t1x==(x+1))&&t2x==x)||(y==4&&t1x==x&&((t2x==(x-1))||(t2x==(x+1))))))
				cout << "Shortcuts";
			else if ((world==4&&((y==2&&t1x==x)||(y==3&&(t1x==(x-1)||t1x==(x+1)||t2x==x))||(y==4&&(t1x==x||t2x!=(x-1)||t2x!=(x+1)))||(y==5&&t2x==x)))||(world==5&&((y==2&&(x==3||x==5))||(y==3&&x==4))))
				cout << "Finish";
		}
		if (world==4&&((y==3&&(t1x==(x-1)||t1x==(x+1))&&t2x==x)||(y==4&&t1x==x&&((t2x==(x-1))||(t2x==(x+1))))))
			cout << endl << "6.Finish";
...
void world4 (int x, int y, int xplace, int t1, int t2, int t1x, int t2x)
{
	int xvismin, xvismax, yvismin, yvismax, xmatch, ymatch;
	xvismin=x-3;
	if (xvismin<1)
...
void world5 (int x, int y, int xplace)
{
	int xvismin, xvismax, yvismin, yvismax, xmatch, ymatch;
	xvismin=x-3;
	if (xvismin<1)
...
void map (int world, int x, int y, int xplace, int t1, int t2, int t1x, int t2x)
{
	...
	{
		world4 (x, y, xplace, t1, t2, t1x, t2x);
	}
	else if (world==5)
	{
		world5 (x, y, xplace);
...
void escape (int tryesc, int lvl2)
{
	if (tryesc>lvl2)
	{
...
void movingalt (int world, int x, int y, int t1x, int t2x)
{
	...
	cout << "1.";
	if ((world==1&&y<9)||(world==2&&y<3)||(world==3&&((y<7&&x<8)||(y<4&&x>7)||(x==10&&y==4)))||(world==4&&((x!=t1x&&y==2)||(x!=t2x&&y==3)||y==4||(y==5&&(x==2||x==4||x==6))))||(world==5&&((y<6&&x!=3&&x!=5)||(y<5&&(x==3||x==5)))))
		cout << "Up" << endl;
	else if (world==1||world==2||world==3||(world==4&&((x==4&&y==2)||y==3||((x==3||x==5)&&x!=t2x&&y==5)||y==6))||(world==5&&((y>2&&x!=4)||(y>3&&x==4))))
		cout << "Down" << endl;
	else if (world==4&&x>2)
		cout << "Left" << endl;
	else
		cout << "Right" << endl;
	cout << "2.";
	if ((world==1&&y<9&&y>1)||(world==2&&y<3&&y>1&&x>4)||(world==3&&((x<8&&y<7&&y>1)||(x>7&&(y==2||y==3))||(x==10&&y==4)))||(world==4&&((y==2&&x==4&&x!=t1x)||(y==3&&x!=t2x)||(y==4&&x!=t1x)||(y==5&&(x==2||x==4||x==6)&&x!=t2x)))||(world==5&&(((y<6&&x!=3&&x!=5)||(y<5&&(x==3||x==5)))&&((y>2&&x!=4)||(y>3&&x==4)))))
		cout << "Down" << endl;
	else if ((world==1&&(y==1&&x>1||y==9&&x>1))||(world==2&&((y==2||y==3)&&x>1||(y==1&&x>5)))||(world==3&&x>1)||(world==4&&((x>2&&((((x!=4&&x!=t1x)||(x==4&&x==t1x))&&y==2)||(y==4&&(x-1)!=t2x)||(y==5&&((x==3&&t2x!=x)||(x==4&&t2x==x)||(x==5&&t2x!=x)||(x==6&&t2x==x)))))||((x-1)!=t1x&&y==3)))||(world==5&&y<6&&((y>2&&x>2)||(y==2&&x!=2&&x!=5))))
		cout << "Left" << endl;
	else if ((world==4&&((y==6&&(x==2||x==6))||(y==2&&x==2&&x==t1x)||(y==3&&x==6&&x==t2x&&(x-1)==t1x)))||(world==5&&y==6&&(x==2||x==6)))
		cout << "Stay" << endl;
	else
		cout << "Right" << endl;
	if (world==1||world==2||world==3||(world==4&&(((x!=2||(x==2&&t1x!=x))&&y==2)||((x!=6||t1x!=5||t2x!=6)&&y==3)||y==4||y==5))||(world==5&&y!=6))
	{
	cout << "3.";
	if ((world==1&&((x==1||x==9)&&(y==1||y==9)))||(world==2&&((x==7&&(y==1||y==3))||(x==1&&y==2)||(x==5&&y==1)))||(world==3&&((y==1&&(x==1||x==12))||(y==4&&x==12)||(y==7&&(x==1||x==7))))||(world==4&&((((x==2&&x!=t1x)||x==6||(t1x==x&&(x==3||x==5)))&&y==2)||(((t1x==(x+1)&&x==2)||(((t1x==(x-1)&&t2x!=x)||(t1x!=(x-1)&&t2x==x))&&x==6)||(((t1x==(x-1))||(t1x==(x+1)))&&t2x==x&&x>2&&x<6))&&y==3)||(((x==2&&(t2x==(x+1)||t1x==x))||(x==6&&t1x!=6&&t2x==5)||(x>2&&x<6&&t1x==x&&((t2x==(x-1))||(t2x==(x+1)))))&&y==4)||((x==3||x==5||x==6)&&t2x==x&&y==5)))||(world==5&&y==2))
		cout << "Stay" << endl;
	else if ((world==1&&((y==1||y==9)&&x<9&&x>1||y<9&&y>1&&x==1))||(world==2&&((x>1&&y==3)||(x>1&&x<5&&y==2)||(x>5&&y==1)))||(world==3&&((x==1&&y>1&&y<7)||(x>1&&x<12&&y==1)||(x>1&&x<7&&y==7)||((x==8||x==9||x==11)&&y==4)))||(world==4&&((y==2&&(((x==3||x==5)&&t1x!=x)||(x==4&&t1x==x)))||(y==3&&((x>2&&(((x-1)!=t1x&&x==t2x)||((x-1)==t1x&&x!=t2x)))||(x==2&&t1x!=(x+1))))||(y==4&&((x>2&&((x==t1x&&(x-1)!=t2x)||(x!=t1x&&(x-1)==t2x)))||(x==2&&t1x!=x&&t2x!=(x+1))))||(y==5&&(((x==3||x==5)&&t2x!=x)||(x==4&&t2x==x)||x==2))))||(world==5&&((y>2&&y<6&&x==2)||(y==5&&(x==3||x==5))||(y==3&&x==4))))
		cout << "Right" << endl;
	else
		cout << "Left" << endl;
	}
	if ((world==1&&(x>1&&x<9||y>1&&y<9))||(world==2&&(x>1&&x<5||(x>4&&x<7&&y==3)||(x>5&&x<7&&y==1)||y==2&&x>4))||(world==3&&((x==1&&y>1&&y<12)||(x>1&&x<7)||(x==7&&y<7)||(x>7&&x<12)||(x==12&&(y==2||y==3))))||(world==4&&((y==2&&(((x==3||x==5)&&x!=t1x)||x==4))||(y==3&&((x==6&&(t1x!=(x-1)&&t2x!=x))||(x>2&&x<6&&((t1x!=(x-1)&&t1x!=(x+1))||t2x!=x))||(x==2&&t1x!=(x+1))))||(((x==2&&t1x!=x&&t2x!=(x+1))||(x==6&&t2x!=(x-1))||((x==3||x==4||x==5)&&((t1x!=x||(t2x!=(x-1)&&t2x!=(x+1))))))&&y==4)||((((x==2||x==6)&&x!=t2x)||x==4||((x==3||x==5)&&x!=t2x))&&y==5)))||(world==5&&y>2&&y<6))
	{
		cout << "4.";
		if ((world==1&&(x>1&&x<9&&y>1&&y<9))||(world==2&&(x>4&&x<7&&y==2))||(world==3&&x>1&&y>1&&x<12&&((x>6&&y<4)||((x==7||x==10)&&y==4)||(x<7&&y<7)))||(world==4&&((x>2&&x<6&&((y==3&&t2x!=x&&t1x!=(x-1)&&t1x!=(x+1))||(y==4&&t1x!=x&&t2x!=(x-1)&&t2x!=(x+1))))||(x==4&&y==2&&t1x!=x)||(x==4&&y==5&&t2x!=x)))||(world==5&&x>2&&x<6&&((y==3&&x!=4)||(y==5&&x==4)||(y==4))))
			cout << "Right" << endl;
		else
			cout << "Stay" << endl;
	}
	if ((world==1&&(x>1&&x<9&&y>1&&y<9))||(world==2&&(x==5||x==6)&&y==2)||(world==3&&x>1&&((x<7&&(y==5||y==6))||(y==4&&(x<8||x==10))||((y==2||y==3)&&x<12)))||(world==4&&((x==4&&y==2&&t1x!=x)||(x>2&&x<6&&((y==3&&t1x!=(x-1)&&t1x!=(x+1)&&t2x!=x)||(y==4&&t1x!=x&&t2x!=(x-1)&&t2x!=(x+1))))||(x==4&&y==5&&t2x!=x)))||(world==5&&x>2&&x<6&&((y==3&&x!=4)||(y==5&&x==4)||(y==4))))
	{
	cout << "5.Stay" << endl;
	}
	cout << "Type here: ";
...
int main()
{
	...
	int hp11, hp12=0, hp13=0, temphp, hp21=0, hp22=0, hp23=0, hpstart11, hpstart12, hpstart13, temphpstart, hpstart21, hpstart22, lvl11=1, lvl12, lvl13, templvl, lvl21, lvl22, strength11, strength12, strength13, tempstrength, strength21, strength22, type11, type12, type13, temptype, type21, type22,typetest=1, exp1=0, exp2=0, exp3=0, tempexp, explvl1, explvl2, explvl3, tempexplvl, pokenamntest=1, pokemonnr=1, playertest=0, deadpokemon=0;
	...
	char poke1[100], poke2[100], poke3[100], temppoke[100], cinstartpokemon[100], cingamealt[100], cinmove[100], cinfight[100], cinatthelp[100], cingoheal[100], cinchange[100], cinpack[100], enemy[100]="Normaldino", cinshow[100];
	srand(time(NULL));
// Bestäm startpokemon, bestämmer via typ
	while (typetest==1)
	{
		cout << "Choose pokémon for Player 1:" << endl << "1.Armeno [Grass]" << endl << "2.Tuba [Fire]" << endl << "3.Plush [Water]" << endl << "Type here: ";
		cin >> cinstartpokemon;
		cout << endl;
...
// Visar alternativ: Move, Pokemon, Prata med T1&T2, Genväg, Finish
			...
			else if (cingamealt[0]=='5'&&cingamealt[1]=='\0'&&((world==4&&((y==2&&t1x==x)||(y==3&&(t1x==(x-1)||t1x==(x+1)||t2x==x))||(y==4&&(t1x==x||t2x==(x-1)||t2x==(x+1)))||(y==5&&t2x==x)))||(world==5&&((y==2&&(x==3||x==5))||(y==3&&x==4)))))
			{
				gamealt=5;
				gamealttest--;
			}
			else if (cingamealt[0]=='6'&&cingamealt[1]=='\0'&&world==4&&((y==3&&(t1x==(x-1)||t1x==(x+1))&&t2x==x)||(y==4&&t1x==x&&(t2x==(x-1)||t2x==(x+1)))))
			{
				gamealt=6;
				gamealttest--;
			}
...
// Kontrollerar att cinmove är giltig
				...
				else if (cinmove[0]=='3'&&cinmove[1]=='\0'&&(world==1||world==2||world==3||(world==4&&((y==2&&((x==2&&t1x!=x)||(x>2)))||(y==3&&((x==6&&((t1x==(x-1)&&t2x!=x)||(t1x!=(x-1)&&t2x==x)||(t1x!=(x-1)&&t2x!=x)))||(x<6)))||(y==4)||(y==5)))||(world==5&&y<6)))
				{
					move=3;
					movetest--;
				}
				else if (cinmove[0]=='4'&&cinmove[1]=='\0'&&((world==1&&(x!=1||x!=9)&&(y!=1||y!=9))||(world==2&&((x>1&&x<5)||(x==5&&y>1)||(x==6)||(x==7&&y==2)))||(world==3&&((x==1&&y>1&&y<7)||(x>1&&x<7)||(x==7&&y<7)||(x>7&&x<12)||(x==12&&y>1&&y<4)))||(world==4&&((y==2&&((x==3||x==5)&&t1x!=x)||(x==4))||(y==3&&((x==2&&t1x!=(x+1))||(x==6&&t1x!=(x-1)&&t2x!=x)||(x>2&&x<6&&((t1x!=(x-1)&&t1x!=(x+1))||(t2x!=x)))))||(y==4&&((x==2&&t1x!=x&&t2x!=(x+1))||(x==6&&t2x!=(x-1))||(x>2&&x<6&&((t1x!=x)||(t2x!=(x-1)&&t2x!=(x+1))))))||(y==5&&((x==2)||(t2x!=x&&(x==3||x==5))||(x==4)||(x==6&&t2x!=x)))))||(world==5&&y<6&&y>2)))
				{
					move=4;
					movetest--;
				}
				else if (cinmove[0]=='5'&&cinmove[1]=='\0'&&((world==1&&y>1&&y<9&&x>1&&x<9)||(world==2&&x==6&&y==2)||(world==3&&y>1&&x>1&&x<12&&((x<7&&y<7)||(x>6&&y<4)||(x==7&&y==4)))||(world==4&&x>2&&x<6&&((y==2&&x==4&&t1x!=x)||(y==3&&t1x!=(x-1)&&t1x!=(x+1)&&t2x!=x)||(y==4&&t1x!=x&&t2x!=(x-1)&&t2x!=(x+1))||(y==5&&x==4&&t2x!=x)))||(world==5&&x>2&&x<6&&((y==3&&x!=4)||(y==4)||(y==5&&x==4)))))
				{
					move=5;
					movetest--;
				}
...
// Kan ej gå på trappan till W6 utan Amateur Key
			...
			if (move==4)
			{
				if (world==1&&x>1&&x<9&&y>1&&y<9)
				{
					x++;
				}
				if (world==2&&((y==1&&(x==5||x==7))||(y==2&&(x==1||x>4&&x<7))||(y==3&&(x==1||x==7))))
				{
					x++;
				}
				if (world==3&&x>1&&y>1&&((x<7&&y<7)||(x<12&&y<4)||(x==7&&y==4)||(x==10&&y==4)))
				{
					x++;
				}
				if (world==4&&((x>2&&x<6&&((y==3&&t1x!=(x-1)&&t1x!=(x+1)&&t2x!=x)||(y==4&&t1x!=x&&t2x!=(x-1)&&t2x!=(x+1))))||(x==4&&y==2&&t1x!=x)||(x==4&&y==5&&t2x!=x)))
				{
					x++;
				}
				if (world==5&&((y==5&&x==4)||(y==4&&x>2&&x<6)||(y==3&&(x==3||x==5))))
				{
					x++;
				}
			}
...
// Kontrollerar om man är i gräs och ifall man isf möter en pokemon
			enetest=rand()%4;
			if ((enetest>1&&((world==1&&(((x==1||x==2)&&y==6)||((x==1||x==2)&&y==7)||(x<4&&y==8)||(x<4&&y==9)))||(world==3&&(((x==3||x==4||x==5)&&(y==5||y==6||y==7))||((x==1||x==2||x==3)&&(y==1||y==2))))))||(t1==2)||(t2==2)||(l1==2))
			{
...
// Tränare 2 Pokemon 2
				...
				if (world==5&&l1==2)
				{
					cout << "Möter L1" << endl; //----bookmark----
				}
// Bestämmer egenskaper för fiendepokemon
				strength21=lvl21;
				hp21=lvl21*10;
				hpstart21=hp21;
...
// Byter till Fiende 2 (Flyttar 2:an till 1:an)
						...
						cout << "Player 2 sends out " << enemy << endl << endl;
						playertest=1;
						pokemon (lvl21, exp2, explvl1, type21, strength21, hp21, hpstart21, enemy, playertest);
						playertest=0;
...
// Fiende 1 är död
					...
					if (hp21==0&&hp22==0&&hp23==0)
					{
						if (t1==2)
						{
							cout << "Trainer 1 is defeated!" << endl << endl;
							t1=0;
						}
						if (t2==2)
						{
							cout << "Trainer 2 is defeated!" << endl << endl;
							t2=0;
						}
						if (l1==2)
						{
							cout << "Ledare 1 is defeated!" << endl << endl;
							amateurkey=1;
							l1=0;
						}
...
// Visa kartan
		...
		else if (gamealt==2&&world==4&&(((y==2&&t1x==x)||(y==3&&(t1x==(x-1)||t1x==(x+1)||t2x==x))||(y==4&&(t1x==x||t2x==(x-1)||t2x==(x+1)))||(y==5&&t2x==x))||((y==3&&(t1x==(x-1)||t1x==(x+1))&&t2x==x)||(y==4&&t1x==x&&(t2x==(x-1)||t2x==(x+1))))))
		{
// Pratar med T1, T2 eller L1 ifall de är angränsande
			if ((y==2&&t1x==x)||(y==3&&(t1x==(x-1)||t1x==(x+1)))||(y==4&&t1x==x))
			{
				cout << "PRATA T1" << endl; //-----bookmark---------
				if (t1==1)
				{
					t1=2;
					gamealt=1;
		...
		else if (gamealt==2&&world==5&&((y==2&&(x==3||x==5))||(y==3&&x==4)))
		{
			cout << "PRATA L1" << endl;
			//MÖTER L1-------------------bookmark
			l1=1;
		}
		else if (gamealt==3&&((world==4&&((y==3&&(t1x==(x-1)||t1x==(x+1))&&t2x==x)||(y==4&&t1x==x&&(t2x==(x-1)||t2x==(x+1)))))))
		{
// Pratar med T2 ifall båda är angränsande
		...
		else if ((gamealt==2)||(gamealt==3&&((world==4&&((y==2&&t1x==x)||(y==3&&(t1x==(x-1)||t1x==(x+1)||t2x==x))||(y==4&&(t1x==x||t2x==(x-1)||t2x==(x+1)))||(y==5&&t2x==x)))||(world==5&&((y==2&&(x==3||x==5))||(y==3&&x==4)))))||(gamealt==4&&world==4&&((y==3&&(t1x==(x-1)||t1x==(x+1))&&t2x==x)||(y==4&&t1x==x&&(t2x==(x-1)||t2x==(x+1))))))
		{
...
// Visar pokemon
		...
		else if (gamealt==3||(gamealt==4&&((world==4&&((y==2&&t1x==x)||(y==3&&(t1x==(x-1)||t1x==(x+1)||t2x==x))||(y==4&&(t1x==x||t2x==(x-1)||t2x==(x+1)))||(y==5&&t2x==x)))||(world==5&&((y==2&&(x==3||x==5))||(y==3&&x==4)))))||(gamealt==5&&world==4&&((y==3&&(t1x==(x-1)||t1x==(x+1))&&t2x==x)||(y==4&&t1x==x&&(t2x==(x-1)||t2x==(x+1))))))
		{
// Shortcut cheats!
			...
			{
// Flyttfusk
				cout << "Where are you going?" << endl << "1.World 5" << endl << "2.World 4" << endl << "3.World 3" << endl << "4.Back" << endl << "Type here: ";
				cin >> movecheat;
				cout << endl;
				if (movecheat==1)
				{
...
// Backar upp ett steg till shortcuts
					if (world==4&&((y==3&&(t1x==(x-1)||t1x==(x+1))&&t2x==x)||(y==4&&t1x==x&&(t2x==(x-1)||t2x==(x+1)))))
						gamealt=5;
					else if (world==4&&((y==2&&t1x==x)||(y==3&&(t1x==(x-1)||t1x==(x+1)||t2x==x))||(y==4&&(t1x==x||t2x==(x-1)||t2x==(x+1)))||(y==5&&t2x==x)))
						gamealt=4;
					else
						gamealt=3;
					gamealttest=0;
...
// Backar upp till valalternativ (move, pokemon, shortcuts, finish)
		...
		else if (gamealt==4||(gamealt==5&&((world==4&&((y==2&&t1x==x)||(y==3&&(t1x==(x-1)||t1x==(x+1)||t2x==x))||(y==4&&(t1x==x||t2x==(x-1)||t2x==(x+1)))||(y==5&&t2x==x)))||(world==5&&((y==2&&(x==3||x==5))||(y==3&&x==4)))))||(gamealt==6&&world==4&&((y==3&&(t1x==(x-1)||t1x==(x+1))&&t2x==x)||(y==4&&t1x==x&&(t2x==(x-1)||t2x==(x+1))))))
		{
// Finish
			spel--;
